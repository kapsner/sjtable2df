test_that(desc = "correct functioning of 2x2 xtab2df, with stats", code = {
  local_edition(3)
  local_reproducible_output(rstudio = TRUE)

  testthat::skip_if_not_installed("sjPlot")
...
test_that(desc = "correct functioning of 2x2 xtab2df, without stats", code = {
  local_edition(3)
  local_reproducible_output(rstudio = TRUE)
...
test_that(desc = "correct functioning of 3x4 xtab2df, with stats", code = {
  local_edition(3)
  local_reproducible_output(rstudio = TRUE)
