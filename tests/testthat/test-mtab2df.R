test_that(desc = "correct functioning of mtab2df: glm", code = {
  local_edition(3)
...
test_that(desc = "correct functioning of mtab2df: glmer", code = {
  local_edition(3)
  local_reproducible_output(rstudio = TRUE)
...
test_that(desc = "correct functioning of mtab2df with significance: glm", code = {
  local_edition(3)
  local_reproducible_output(rstudio = TRUE)
